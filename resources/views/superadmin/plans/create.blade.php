...
@section('superadmin_page_title', 'Create Plan')
...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="sa-card">
            <div class="mb-4">
                <h5 class="fw-bold mb-1">Create New Plan</h5>
                <p class="text-muted small mb-0">Define a subscription plan available to users</p>
            </div>
            ...
            <form method="POST" action="{{ route('superadmin.plans.store') }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="monthly_price" value="{{ old('monthly_price', 0) }}"
                               step="0.01" min="0"
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description" rows="2"
                                  ...
                                  placeholder="Short description of this plan…">{{ old('description') }}</textarea>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="max_managers" value="{{ old('max_managers', 1) }}"
                               min="1"
