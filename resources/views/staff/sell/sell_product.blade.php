    ...
    <div class="receipt-modal" id="receiptModal">
      <div class="receipt-container">
        <div class="receipt-header">
          @php
            $businessUser = \App\Models\User::where('business_name', $staff->business_name)
                                           ->where('addby', null)
                                           ->first();
            $receiptSettings = \App\Models\ReceiptSetting::getForBusiness($staff->business_name);
          @endphp
          ...
          <div class="business-name">{{ $staff->business_name }}</div>
