                  ...
                  <div class="card-body">
                    ...
                    <div class="row mb-3 filter-container">
                      ...
                      <div class="col-md-8 d-flex justify-content-end align-items-center gap-2">
                        ...
                        <a href="{{ route('manager.sales_summary.export', 'excel') }}" class="btn btn-outline-success"><i class="bi bi-file-earmark-excel"></i> Excel</a>
                        <a href="{{ route('manager.sales_summary.export', 'pdf') }}" class="btn btn-outline-danger"><i class="bi bi-file-earmark-pdf"></i> PDF</a>
                      </div>
