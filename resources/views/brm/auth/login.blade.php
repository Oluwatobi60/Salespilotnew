...
<head>
    ...
    <title>Business Relation Manager Login - SalesPilot</title>
        ...
        <div class="col-md-6 col-lg-5">
            ...
            <div class="card shadow-lg">
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="{{ route('brm.login.submit') }}">
                        @csrf
                        ...
                        <button type="submit" class="btn btn-brm w-100 py-2 fw-semibold">Log In</button>
                    </form>
